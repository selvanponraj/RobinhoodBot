...
def get_sp_X00(index=500):
    resp = requests.get(f'https://en.wikipedia.org/wiki/List_of_S%26P_{index}_companies')
...
def get_nasdaq_100():
    ...
    for i in range(len(main_data)):
        nasdaq_100.append(main_data[i]['symbol'])
    return nasdaq_100
...
#     print("All",len(tickers),len(set(tickers)))
   

#     # tickers from AMEX only
#     amex_tickers =get_tickers(NASDAQ=False, NYSE=False)
#     print("AMEX",len(amex_tickers),len(set(amex_tickers)))

#     # tickers from NYSE only
#     nyse_tickers =get_tickers(AMEX=False, NASDAQ=False)
#     print("NYSE",len(nyse_tickers),len(set(nyse_tickers)))

#     # tickers from NASDAQ only
#     nasdaq_tickers =get_tickers(AMEX=False, NYSE=False)
#     print("NASDAQ",len(nasdaq_tickers),len(set(nasdaq_tickers)))
...
#     top_5 = get_biggest_n_tickers(10,NYSE=False, AMEX=False)
#     print(top_5)

#     # sp_600 = get_sp_X00(index=600)
#     # print(len(set(sp_600)))
#     # sp_500 = get_sp_X00(index=500)
#     # print(len(set(sp_500)))

    nasdaq_100 = get_nasdaq_100()
    print(nasdaq_100)
    # print(len(set(nasdaq_100)))
